// ============================================================
// Unified Memory Types (MemGPT-inspired)
// ============================================================

/** Platform-prefixed chat ID */
export type ChatId = string; // e.g. 'fb_123', 'tg_456', 'line_U789'

/** Core Memory block — always injected into system prompt */
export interface CoreMemoryBlock {
    label: string;      // 'human', 'persona', 'preferences'
    value: string;      // Content of the block
    updatedAt: string;
}
