 ...
 */
function assembleMessages(systemPrompt, recentMessages, newMessage, limit = RECENT_MESSAGE_COUNT) {
    ...
    const messages = new Array(recent.length + 2);
 ...
 */
function sanitizePromptInput(text, maxLength = 1000, neutralize = true) {
    if (!text)
        return '';
...
export function buildChatMessages(systemPrompt, memory, newMessage) {
