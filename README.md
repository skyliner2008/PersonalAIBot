...
ระบบ autonomous ที่เรียนรู้และพัฒนาตัวเองได้ — ทำงานเหมือน developer จริง: มี **Graph-Enhanced Second Brain** ที่เข้าใจโครงสร้างทั้ง codebase, วิเคราะห์ impact แบบ multi-hop, วางแผนก่อนลงมือ, เรียนรู้จากความผิดพลาด
...
**หมายเหตุ**: คุณสามารถตั้งค่า API Keys และรหัสผ่านได้โดยตรงผ่านหน้า Dashboard หลังจากรันระบบครั้งแรก (รหัสผ่านเริ่มต้นคือ `admin / admin`) หากมีการเปลี่ยนแปลง `CRED_SECRET` หรือไฟล์ Salt ในภายหลัง ระบบจะทำการ **Auto-Purge (ล้างข้อมูล)** เฉพาะส่วนที่ถอดรหัสไม่ได้ทิ้งโดยอัตโนมัติเพื่อความปลอดภัยและความเสถียรถาวร คุณเพียงแค่กรอก API Key ใหม่ผ่าน Dashboard อีกครั้งก็เป็นอันเสร็จสิ้น
