...
**หมายเหตุ**: คุณสามารถตั้งค่า API Keys และรหัสผ่านได้โดยตรงผ่านหน้า Dashboard หลังจากรันระบบครั้งแรก (รหัสผ่านเริ่มต้นคือ `admin / admin`) หากต้องการย้ายเครื่อง แค่ก๊อปปี้โฟลเดอร์ `data/` ไปด้วย ระบบก็จะจำทุกอย่างได้ทันที
