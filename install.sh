#!/usr/bin/env bash
# ============================================================
#   PersonalAIBot — One-File Standalone Installer (Linux/macOS)
#
...
#   Or:
#     wget -qO install.sh https://raw.githubusercontent.com/skyliner2008/PersonalAIBot/main/install.sh
...
REPO_URL="https://github.com/skyliner2008/PersonalAIBot.git"
REPO_NAME="PersonalAIBot"
INSTALLER_DIR="$(pwd)"
NEED_RELOGIN=0
STEP=0
TOTAL_STEPS=9
...
echo -e "${CYAN}  ╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}  ║                                                          ║${NC}"
echo -e "${CYAN}  ║   PersonalAIBot — One-Click Installer                   ║${NC}"
echo -e "${CYAN}  ║                                                          ║${NC}"
...
if [ -f "server/.env" ]; then
    ...
    const env=[
        '# PersonalAIBot Server Configuration',
...
if [[ "${LAUNCH:-Y}" != "n" && "${LAUNCH:-Y}" != "N" ]]; then
    echo ""
    echo -e "  ${GREEN}Starting PersonalAIBot...${NC}"
    echo ""
