...
if exist "%INSTALLER_DIR%server\package.json" (
    ...
    powershell -NoProfile -Command "%PS_OK% ' Project files already present (running from project folder)'"
    cd /d "!PROJECT_DIR!"
    goto :project_ready
)
