...
:: ============================================================
::   PersonalAIBot -- One-File Standalone Installer (Windows)
::
...
set "REPO_URL=https://github.com/skyliner2008/PersonalAIBot.git"
set "REPO_NAME=PersonalAIBot"
...
powershell -NoProfile -Command "Write-Host '  |                                                          |' -ForegroundColor Cyan"
powershell -NoProfile -Command "Write-Host '  |   PersonalAIBot -- One-Click Installer                     |' -ForegroundColor Cyan"
powershell -NoProfile -Command "Write-Host '  |                                                          |' -ForegroundColor Cyan"
...
if /I \"!LAUNCH!\" neq \"n\" (
    echo.
    powershell -NoProfile -Command \"Write-Host '  Starting PersonalAIBot...' -ForegroundColor Green\"
    echo.
    if exist \"start.bat\" (
        call start.bat
    ) else (
